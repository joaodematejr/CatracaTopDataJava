package com.alquimidia.enumeradores;

public class Enumeradores {

	public enum EstadosTeclado {

		TECLADO_EM_BRANCO, AGUARDANDO_TECLADO
	}

	public enum EstadosInner {

		ESTADO_CONECTAR, ESTADO_ENVIAR_CFG_OFFLINE, ESTADO_COLETAR_BILHETES, ESTADO_ENVIAR_CFG_ONLINE,
		ESTADO_ENVIAR_DATA_HORA, ESTADO_ENVIAR_MSG_PADRAO, ESTADO_CONFIGURAR_ENTRADAS_ONLINE, ESTADO_POLLING,
		ESTADO_LIBERAR_CATRACA, ESTADO_ENVIAR_BIPCURTO, ESTADO_MONITORA_GIRO_CATRACA, ESTADO_PING_ONLINE,
		ESTADO_RECONECTAR, ESTADO_AGUARDA_TEMPO_MENSAGEM, ESTADO_DEFINICAO_TECLADO, ESTADO_AGUARDA_DEFINICAO_TECLADO,
		ESTADO_ENVIA_MSG_URNA, ESTADO_MONITORA_URNA, ESTADO_ACIONAR_RELE1, ESTADO_ACIONAR_RELE2,
		ESTADO_ENVIAR_MSG_OFFLINE_CATRACA, ESTADO_ENVIAR_CONFIGMUD_ONLINE_OFFLINE, ESTADO_ENVIAR_MSG_ACESSO_NEGADO,
		ESTADO_CAPTURA_HAMSTER, ESTADO_VERIFICA_USR_HAMSTER, ESTADO_ENVIA_USUARIO_ONLINE_INNER_ACESSO,
		ESTADO_ENVIA_USUARIO_ONLINE_INNER_NET, ESTADO_PREPARA_ENVIO_TEMPLATES_ONLINE,
		ESTADO_EXCLUI_TEMPLATE_ONLINE_INNERACESSO, ESTADO_EXCLUI_TEMPLATES_ONLINE_INNERNET,
		ESTADO_VERIFICA_TIPO_INNER_EXCLUSAO, ESTADO_VERIFICA_TIPO_INNER, ESTADO_TRATAR_RET_BIO_ACESSO,
		ESTADO_TRATAR_RET_BIO_NET, ESTADO_VALIDA_URNA_CHEIA, ESTADO_ENVIAR_MSG_URNA_CHEIA, ESTADO_VALIDAR_ACESSO,
		ESTADO_RECEBER_FIRWARE, ESTADO_RECEBER_MODELO_BIO, ESTADO_ENVIAR_LISTA_OFFLINE, ESTADO_ENVIAR_LISTA_SEMDIGITAL,
		ESTADO_RECEBER_QTD_BILHETES_OFF, ESTADO_ENVIAR_MSG_OFFLINE_COLETOR, ESTADO_RECEBER_VERSAO_BIO,
		ESTADO_DESLIGAR_RELE
	}

	public enum TiposTempl {
		HFir, TextCode, Fir, Dados
	}
	...
	public static final int TIPO_MODULO_LN = 0;
	public static final int TIPO_MODULO_LC = 1;
